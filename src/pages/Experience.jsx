        ...
        <div className="space-y-6 relative">
          ...
          {experienceData.map((exp, idx) => (
            ...
            >
              ...
              <div className="bg-slate-800/60 backdrop-blur-lg rounded-2xl p-8 border border-slate-700 w-full md:w-5/12 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-blue-500/10">
